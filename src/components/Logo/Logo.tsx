...
export const Logo = (props: Props) => {
  ...
  return (
    <span className={clsx('group flex items-center gap-3', className)}>
      <svg
        className="h-10 w-10 shrink-0 transition-transform duration-300 group-hover:rotate-[10deg]"
        viewBox="0 0 37 37"
        fill="none"
      ...
      <span className="font-display text-xl leading-none tracking-tight whitespace-nowrap">
        En<span className="text-primary">Design</span>
      </span>
    </span>
  )
}
