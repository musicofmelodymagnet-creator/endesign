...
export interface TextImageBlock {
  ...
  background?: ('default' | 'dark' | 'light') | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'textImage';
}
...
export interface Service {
  ...
  price?: string | null;
  /**
   * Lower numbers show first in listings (matches the priority order from the legacy site menu).
   */
  menuOrder?: number | null;
  /**
   * Show this item as a bold, prioritized entry in the header "Послуги" dropdown menu.
   */
  menuHighlight?: boolean | null;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact';
    richText?: {
      root: {
  ...
  layout?:
    | (ContentBlock | MediaBlock | GalleryBlock | IconListBlock | TextImageBlock | PriceListBlock | CallToActionBlock)[]
    | null;
  meta?: {
    title?: string | null;
    /**
...
export interface CaseStudy {
  ...
  /**
   * Short one-line description of the client (e.g. "Dance studio").
   */
  tagline?: string | null;
  relatedService?: (number | null) | Service;
  layout?: (ContentBlock | MediaBlock | GalleryBlock | TextImageBlock)[] | null;
  meta?: {
    title?: string | null;
    /**
     * Maximum upload file size: 12MB. Recommended file size for images is <500KB.
...
/**
 * Всі тексти головної сторінки сайту (endesign.com.ua).
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Home {
  ...
  subhead?: string | null;
  ctaDiscussLabel?: string | null;
  ctaViewWorkLabel?: string | null;
  marquee?:
    | {
        text: string;
        id?: string | null;
  ...
  /**
   * Зазвичай тут 3 картки: Графічний дизайн, Розробка сайтів, 3D-візуалізація.
   */
  pillars?:
    | {
        tag?: string | null;
  ...
  viewAllServicesLabel?: string | null;
  portfolioSectionTitle?: string | null;
  viewAllProjectsLabel?: string | null;
...
export interface HomeSelect<T extends boolean = true> {
  ...
  viewAllServicesLabel?: T;
  portfolioSectionTitle?: T;
  viewAllProjectsLabel?: T;
  ctaBannerTitle?: T;
